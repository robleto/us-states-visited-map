...
class USStatesMap {
	...
	resetMap() {
		...
		allStates.forEach((state) => {
			gsap.set(state, { fill: "#D3D3D3" });
		});

		// Reset date display
		const dateElement = document.getElementById("dateDisplay");
		if (dateElement) {
			dateElement.textContent = "1976";
		}
